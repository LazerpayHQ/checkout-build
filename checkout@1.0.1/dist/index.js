function LazerCheckout({email:e="",amount:t=0,name:n="",coin:i="",currency:o="",logo:a="",key:r="",reference:s="",onSuccess:l,onClose:m,onError:c}){const u=r?.includes("test"),d="https://api.lazerpay.engineering/api/v1/coins",p="https://api.lazerpay.engineering/api/v1/transaction/initialize",h="https://api.lazerpay.engineering/api/v1/transaction/verify",g=(.01*parseFloat(t)).toFixed(2);var f=parseFloat(t)+parseFloat(g);let x=document.createElement("div"),C=document.createElement("section"),y=document.createElement("div");C.id="__LazerpayPortal__",x.classList.add("LazerCheckout-overlay"),y.classList.add("LazerCheckout-container-wrapper"),x.appendChild(y),document.body.appendChild(C);let z=C.attachShadow({mode:"closed"});z.appendChild(x);let v=new CSSStyleSheet;v.replaceSync(`
      @font-face {
