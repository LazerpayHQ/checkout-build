function LazerCheckout({email:e="",amount:t=0,name:n="",coin:i="",currency:o="",logo:a="",key:r="",reference:s="",acceptPartialPayment:l=!1,onSuccess:c,onClose:d,onError:p,payment_link_id:m,payment_button_id:h}){const f=r?.includes("test"),u="https://api.lazerpay.engineering/api/v1/coins",g="https://api.lazerpay.engineering/api/v1/transaction/initialize",x="https://api.lazerpay.engineering/api/v1/transaction/verify",y=e=>(.01*parseFloat(e||t)).toFixed(2);var z=parseFloat(t)+parseFloat(y());let C=null;const v=e=>parseFloat(Number(e))?(""+e).replace(/(\d)(?=(\d{3})+(?!\d))/g,"$1,"):"0.00";let b=document.createElement("div"),w=document.createElement("section"),L=document.createElement("div");const E=`
    @font-face {
      font-family: "proxima";
      font-style: normal;
      font-weight: 400;
