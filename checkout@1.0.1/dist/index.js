function LazerCheckout({email:e="",amount:t=0,name:n="",coin:i="",currency:o="",logo:a="",key:r="",reference:s="",acceptPartialPayment:l=!1,onSuccess:c,onClose:d,onError:p,paymentLinkId:m,paymentButtonId:h,metadata:f}){let u=null;const g=r?.includes("test"),x="https://api.lazerpay.engineering/api/v1/coins",y="https://api.lazerpay.engineering/api/v1/transaction/initialize",z="https://api.lazerpay.engineering/api/v1/transaction/verify",C=e=>e||t?(.01*parseFloat(e||t)).toFixed(2):"0.00",v=e=>e&&parseFloat(Number(e))?(""+e).replace(/(\d)(?=(\d{3})+(?!\d))/g,"$1,"):0;var b=(parseFloat(t)+parseFloat(C()))?.toFixed(2);let w=document.createElement("div"),L=document.createElement("section"),E=document.createElement("div");const k=`
    @font-face {
      font-family: "proxima";
      font-style: normal;
      font-weight: 400;
  ...
  `;function S(e){return function(){if(!document.querySelector('style[title="__LazerpayStyle__"]')){const e=document.createElement("style");e.title="__LazerpayStyle__",e.appendChild(document.createTextNode(k)),document.head.appendChild(e)}}(),`
      ${g?'<div class="Lazer-dev-env">TestNet</div>':""}
          ...
          <div class="LazerCheckout-container-header-wrapper">
              ...
              <div class="LazerCheckout-header-right">
                ...
                <div class="LazerCheckout-header-right-amount">
                  ...
                  <sub id="header--fee" class="header--fee">(${v(C())} fee)</sub>
                </div>
              </div>
          </div>
