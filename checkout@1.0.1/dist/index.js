function LazerCheckout({email:e="",amount:t=0,name:i="",coin:n="",currency:o="",logo:a="",key:r="",reference:s="",acceptPartialPayment:l=!1,onSuccess:c,onClose:d,onError:p,paymentLinkId:m}){const h=r?.includes("test"),f="https://api.lazerpay.engineering/api/v1/coins",g="https://api.lazerpay.engineering/api/v1/transaction/initialize",u="https://api.lazerpay.engineering/api/v1/transaction/verify",x=e=>(.01*parseFloat(e||t)).toFixed(2);var y=parseFloat(t)+parseFloat(x());let z=null;const C=e=>parseFloat(Number(e))?(""+e).replace(/(\d)(?=(\d{3})+(?!\d))/g,"$1,"):"0.00";let v=document.createElement("div"),b=document.createElement("section"),w=document.createElement("div");const L=`
    @font-face {
      font-family: "proxima";
      font-style: normal;
      font-weight: 400;
  ...
  `;function E(e){return function(){if(!document.querySelector('style[title="__LazerpayStyle__"]')){const e=document.createElement("style");e.title="__LazerpayStyle__",e.appendChild(document.createTextNode(L)),document.head.appendChild(e)}}(),`
      ${h?'<div class="Lazer-dev-env">TestNet</div>':""}
          ...
          <div class="LazerCheckout-container-header-wrapper">
              ...
              <div class="LazerCheckout-header-right">
                ...
                <div class="LazerCheckout-header-right-amount">
                  <span id="header-amount">${C(e.amount)} ${e.currency}</span>
                  <sub id="header--fee" class="header--fee">(${C(x())} fee)</sub>
                </div>
              </div>
          </div>
          ...
          <div id="section4" class="lazer-section-four lazer-section-hide" >
            ...
            <div class="lazer-section-four-barcode">
              ...
              <div class="lazer-section-four-amount-to-pay">
                ...
                <h2 class="lazer-section-four-amount-to-payNOW lazer-section21232-amoun-coin-12332">${C(e.amount)} ${e.coin}</h2>
              </div>
            </div>
        ...
        <div id="section6" class="lazer-section-six lazer-section-hide" >
          ...
          <div class="lazer-section-five-content">
            ...
            <div class="lazer-section-footer-amount-ppss">
              <p>Amount</p>
              <h2 class="lazer-section21232-amoun-coin-12332" >${C(e.amount)} ${e.currency}</h2>
            </div>
          </div>
        </div>
        ...
        <div id="section7" class="lazer-section-seven lazer-section-hide">
          ...
          <div class="lazer-section-five-content">
            ...
            <div class="lazer-section-five-content-jefjhef">
              <h3 data-id="confirmedAmount" id="confirmedAmount" class="lazer-section-seveen-content-xxed lazer-section-success-amount lazer-section21232-amoun-coin-12332">${C(e.amount)} ${e.coin} </h3>
            ...
            <div class="lazer-section-footer-amount-ppss">
              <p>Amount</p>
              <h2 data-id="footer-amount" class="lazer-section-success-amount"> ${C(e.amount)} ${e.currency}</h2>
            </div>
          </div>
        </div>
        ...
        <div id="section8" class="lazer-section-eight lazer-section-hide" >
          ...
          <div class="lazer-section-five-content">
            ...
            <div class="lazer-section-eight-content-jefjhef">
              <p class="lazer-section-eight-content-xxed lazer-section-partial-amount-amountPaid lazer-section21232-amoun-coin-12332">${C(e.amount)} ${e.coin}</p>
            ...
            <div class="lazer-section-footer-amount-ppss">
              <p>Amount</p>
              <h2 class="lazer-section-partial-amount lazer-section21232-amoun-coin-12332">${C(e.amount)} ${e.currency}</h2>
            </div>
          </div>
        </div>
        ...
        <div id="section9" class="lazer-section-nine lazer-section-hide" >
          ...
          <div class="lazer-section-five-content">
            ...
            <div class="lazer-section-footer-amount-ppss">
              <p>Amount</p>
              <h2 class="lazer-section-failure-amount lazer-section21232-amoun-coin-12332">${C(e.amount)} ${e.currency}</h2>
            </div>
          </div>
        </div>
      </div>
  ...
  `}b.id="__LazerpayPortal__",v.classList.add("LazerCheckout-overlay"),w.classList.add("LazerCheckout-container-wrapper"),v.appendChild(w),document.body.appendChild(b);let k=b.attachShadow({mode:"open"});k.appendChild(v);let S,T,F={},B=!0,A=i,j=s,q=e,H=t,_=n,P=o,M="",$={qrReady:!1};!function(r){if(!r.amount)return window.alert("Amount and coin must be passed");if(!r.key)return window.alert("Key must be passed");const e=document.createElement("script");e.src="https://js.pusher.com/7.0.3/pusher.min.js",e.title="__LazerpayScript__",e.async=!0;var t=()=>{S=new Pusher("be52401726705f906656",{cluster:"ap2"})};e.addEventListener("load",t),e.addEventListener("complete",t),e.addEventListener("error",()=>{console.log("::::Error connecting Pusher::::")}),document.body.appendChild(e);const i=document.createElement("script");i.type="text/javascript",i.src="https://unpkg.com/qr-code-styling@1.5.0/lib/qr-code-styling.js",i.title="__LazerpayScript__",i.onload=()=>$.qrReady=!0,document.body.appendChild(i),w.innerHTML=E(r);const s=k.querySelectorAll("#modal-closure-btn"),l=k.querySelector(".lazer-section-one"),c=k.querySelector(".lazer-section-three"),d=k.querySelector("#lazer-section-four-confrim-transferBtn"),p=k.querySelector("#lazer-section-six-made-transfer-tryAgain"),m=k.getElementById("nameInput"),h=k.getElementById("emailInput");setTimeout(()=>{O(),l.classList.add("lazer-section-show");const e=k.querySelector(".lazer-section-eight-complete-payment"),t=k.querySelector(".lazer-section-one-button");k.querySelector(".lazer-copy-button").addEventListener("click",J);const i=k.querySelector(".LazerCheckout-body"),n=k.getElementById("confirm-close");s.forEach(e=>{e.addEventListener("click",()=>{n.setAttribute("style","display: flex"),s.forEach(e=>e?.setAttribute("style","display: none !important")),i.setAttribute("style","filter:  blur(8px); transition: .2s cubic-bezier(0.075, 0.82, 0.165, 1);")})});const o=k.querySelectorAll("#confirm-close-btn"),a={proceed:()=>Z(),abort:()=>{i.setAttribute("style","filter: none"),n.setAttribute("style","display: none"),s.forEach(e=>e?.setAttribute("style","display: flex"))}};o.forEach(e=>{e.addEventListener("click",({target:e})=>a[e.getAttribute("data-action")]?.())}),d.addEventListener("click",Y),m.addEventListener("input",()=>function(e,t,i){A=e.value,Number(e.value.length&&t.value.length&&Q(t.value))?(i.classList.remove("opacity"),i.removeAttribute("disabled")):(i.classList.add("opacity"),i.setAttribute("disabled",!0))}(m,h,t)),h.addEventListener("input",()=>function(e,t,i){q=t.value,Number(e.value.length&&t.value.length&&Q(t.value))?(i.classList.remove("opacity"),i.removeAttribute("disabled")):(i.classList.add("opacity"),i.setAttribute("disabled",!0))}(m,h,t)),e.addEventListener("click",W),t.addEventListener("click",()=>{A=m.value,q=h.value,k.querySelector("#LazerCheckoutEmailInput").innerText=h.value,G(c,l),R()}),async function(e,t,i){e.email&&e.name&&(await R(),G(t,i))}(r,c,l),p.addEventListener("click",U)},2e3)}({email:q,name:A,amount:y,coin:n,currency:o,logo:a,key:r,lazerpay_user_reference:j,lazerpay_accept_partial_payment:l,payment_link_id:m});const V=k.querySelectorAll(".lazer-section21232-amoun-coin-12332");let I=k.querySelectorAll(".lazer-section-three-coin-wrapper");a=k.querySelector(".initial-loader");const D=k.getElementById("go-back-coin-selection");function N(e){const t="string"==typeof e?k.querySelector(e):e;return t.innerHTML='<div class="lds-ellipsis"><div></div><div></div><div></div><div></div></div>',()=>{t.innerHTML=""}}const O=N(a);function Z(e=""){var t=document.querySelectorAll("style"),i=document.querySelectorAll("script");clearTimeout(window.lazerCountDownTimer),clearTimeout(window.lazerConfirmPaymentTimeOut),clearTimeout(window.lazerCopyTimer),k.removeChild(v),d?.(e),document.body.removeChild(b),[...t,...i].forEach(e=>{["__LazerpayStyle__","__LazerpayScript__","__LazerpayPortal__"].includes(e.title)&&e.remove()})}function R(){const c=k.querySelector("#lazer-section-three-spinner");N(c);try{fetch(f,{method:"GET",headers:{"Content-Type":"application/json","x-api-key":r}}).then(e=>e.json()).then(({status:e,message:t,data:i=[]}={})=>{const n=k.getElementById("coins-list");if(O(),401===e&&t)return c.innerHTML=`<h3 id="lazer---id--errr">${t||"Error getting coins"}</h3>`;c.innerHTML="<h3>Select the coin you want to pay with:</h3>";for(var{logo:o,id:a,name:r,status:s,symbol:l}of[...i].reverse())"active"===s&&(n.innerHTML+=`
            ...
            `)}).finally(()=>{O(),X({isDisabled:!1}),I=k.querySelectorAll(".lazer-section-three-coin-wrapper");for(let e=0;e<I.length;e++){const t=I[e];t.addEventListener("click",()=>ee(t?.getAttribute("data-coin")))}})}catch(e){return O(),c.innerHTML=`<h3 id="lazer---id--errr">${e?.message||"Error getting coins"}</h3>`}}function G(e,t){t.classList.remove("lazer-section-show"),t.classList.add("lazer-section-hide"),e.classList.remove("lazer-section-hide"),e.classList.add("lazer-section-show")}function W(){var e=k.querySelector(".lazer-section-four"),t=k.querySelector(".lazer-section-eight");let i=k.getElementById("header--fee"),n=k.getElementById("header-amount");if(G(e,t),K(B),l){const o=(z||{})["data"],a=o?.actualAmount-o?.amountPaid;V.forEach(e=>e.innerText=C(a)+" "+o?.currency),n.innerText=C(a)+" "+o?.currency,i.innerText=`(${C(x(a))} fee)`;t={...T,amount:a};T=t,ee(o?.coin,T)}}function U(){var e=k.querySelector(".lazer-section-six");G(k.querySelector(".lazer-section-four"),e),K(B),fetch(g,{method:"POST",headers:{"Content-Type":"application/json","x-api-key":T.key},body:JSON.stringify({...T})}).then(async e=>{e=await e.json();F=e;const t=S.subscribe("DEPOSIT_EVENT");t.bind(""+e.address,e=>{te()})}).catch(e=>{k.querySelector("#lazer-section-three-spinner").innerHTML=`<h3 id="lazer---id--errr">${e?.message||"Something went wrong. Please try again."}</h3>`})}function Q(e){return!!String(e).toLowerCase().match(/^(([^<>()[\]\\.,;:\s@"]+(\.[^<>()[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/)}function Y(){k.getElementById("lazerSectionProgressBar").innerText="0:0",k.getElementById("confirm-payment-amount").innerText=C(F?.cryptoAmount)+" "+F?.coin,B=!1,clearTimeout(window.lazerCountDownTimer);var e=k.querySelector(".lazer-section-four");G(k.querySelector(".lazer-section-five"),e),window.lazerConfirmPaymentTimeOut=setTimeout(()=>{k.getElementById("lazerSectionProgressBar").innerHTML="0:0",G(k.querySelector(".lazer-section-six"),k.querySelector(".lazer-section-five"))},6e5)}function J(){k.querySelector(".lazer-copy-button-text").innerText="Copied",navigator.clipboard.writeText(F.address),setTimeout(()=>{k.querySelector(".lazer-copy-button-text").innerText="Copy"},3e3)}function K(s,e){if(k.getElementById("lazerSectionProgressBar").innerHTML="4:59",e)return clearTimeout(window.lazerCountDownTimer),void(k.getElementById("lazerSectionProgressBar").innerHTML="0:0");function l(e){return e<0&&(e="59"),String(e).padStart(2,0)}!function e(){let t=k.getElementById("lazerSectionProgressBar").innerHTML;let i=t.split(/[:]+/);let n=i[0];let o=l(i[1]-1);59==o&&(n-=1);if(n<0)return;k.getElementById("lazerSectionProgressBar").innerHTML=n+":"+o;if(0==n&&0==o&&s){clearTimeout(window.lazerCountDownTimer),k.getElementById("lazerSectionProgressBar").innerHTML="0:0";const a=k.querySelector(".lazer-section-six "),r=k.querySelector(".lazer-section-four ");G(a,r)}window.lazerCountDownTimer=setTimeout(e,1e3)}()}function X({isDisabled:t=!0,excludedCoins:i=[]}={}){I?.forEach(e=>i.includes(e.getAttribute("data-coin"))?void e.setAttribute("style",`pointer-events: ${t?"none":"initial"};`):null)}function ee(t,e){X(),document.querySelectorAll(".lazer-section-coin-address").forEach(e=>e.innerText=t+" Address"),document.querySelectorAll(".lazer-section21232-amoun-coin-12332").forEach(e=>e.innerText=C(H)+" "+o),_=t;var i={reference:j,customer_name:A,customer_email:q,amount:H,currency:P,coin:_,key:r,accept_partial_payment:l,payment_link_id:m};T=e||i,N("#lazer-section-three-spinner");fetch(g,{method:"POST",headers:{"Content-Type":"application/json","x-api-key":T.key},body:JSON.stringify({...T})}).then(async e=>{X({isDisabled:!1});let t=await e.json();if([200,201,202].includes(e?.status)){M=t?.data?.businessName,k.querySelector("#lazer-section-three-spinner").innerHTML="<h3>Select coin you want to pay with</h3>",k.querySelector(".lazer-section-four-amount-to-payNOW").innerText=`${C(t?.data?.cryptoAmount)}  ${t?.data?.coin} `,k.querySelector(".lazer-section-address").innerText=t?.data?.address.slice(0,27)+"...",$.qrReady&&function({address:e,QRElement:t}){const i=new QRCodeStyling({width:130,height:130,type:"svg",data:e,image:"https://res.cloudinary.com/njokuscript/image/upload/v1644612600/logo_eqnl6x.svg",dotsOptions:{color:"#003585",type:"rounded"},cornersSquareOptions:{color:"#F18971"},backgroundOptions:{color:"transparent"},imageOptions:{crossOrigin:"anonymous",margin:8}});k.querySelector("#lazerpay-qr-code").innerHTML="",i.append(t)}({address:t?.data?.address,amountInBNB:t?.data?.cryptoAmount,QRElement:k.querySelector("#lazerpay-qr-code")});const i=S.subscribe("DEPOSIT_EVENT");i.bind(""+t?.data?.address,e=>{te()}),F=t.data,K(B);const n=k.querySelector(".lazer-section-three"),o=k.querySelector(".lazer-section-four");G(o,n),D.addEventListener("click",()=>{G(n,o),K(B,!0),k.querySelector("#lazerpay-qr-code").innerHTML=""})}else k.querySelector("#lazer-section-three-spinner").innerHTML=`<h3 id="lazer---id--errr">${t?.message||"Something went wrong. Please try again."}</h3>`}).catch(e=>{X({isDisabled:!1}),k.querySelector("#lazer-section-three-spinner").innerHTML=`<h3 id="lazer---id--errr">Error occurred: ${e.message||""}</h3>`})}function te(){var e=k.querySelector(".lazer-section-four");const n=k.querySelector(".lazer-section-five");k.getElementById("lazerSectionProgressBar").innerHTML="0:0",B=!1,clearTimeout(window?.lazerCountDownTimer),clearTimeout(window?.lazerConfirmPaymentTimeOut),G(n,e),fetch(u+"/"+F?.address,{method:"GET",headers:{"Content-Type":"application/json","x-api-key":r}}).then(async e=>{const i=await e?.json();z=i;const t={error:()=>{G(k.querySelector(".lazer-section-nine"),n),p?.(i?.data)},confirmed:()=>{var e=k.querySelector("#section7");const t=k.querySelectorAll(".lazer-section-success-amount");t.forEach(e=>{var t="confirmedAmount"===e.getAttribute("data-id");if("footer-amount"!==e.getAttribute("data-id"))return e.innerHTML=`${C(i?.data?.amountPaid)} ${i?.data?.coin} 
                    `+(t?`<sub>(${C(i?.data?.feeInCrypto)} ${i?.data?.coin} fee)</sub>`:"")}),k.querySelector(".lazer-section-PaidTODATA").innerText="Paid to "+M,G(e,n),c?.(i?.data)},incomplete:()=>{k.querySelector(".lazer-section-four-amount-to-payNOW").innerText=`${C(i?.data?.actualAmount-i?.data?.amountPaid)}  ${i?.data?.coin} `,k.querySelector(".lazer-section-partial-amount-amountPaid").innerText=`${C(i?.data?.amountPaid)} ${i?.data?.coin} (-${C(i?.data?.feeInCrypto)} ${i?.data?.coin} fee)`,k.querySelector(".lazer-section-PaidTODATA-Partial").innerText="Paid to "+M,G(k.querySelector(".lazer-section-eight"),n),c&&c(i?.data)}};t[i?.data?.status]?.()}).catch(e=>{p?.(e.message||"Something went wrong, please try again.")})}return{closeModal:Z}}
